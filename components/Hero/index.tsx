    ...
    return (
        <div className="flex bg-[#F7FAFC] h-[490px] justify-center items-center">
            <div className="text-center">
                ...
                <div className={`font-bold text-x1 text-white bg-[${btnColor ? btnColor : '#03A9F4'}] px-[60px] py-[25px] rounded-md ease-in-out duration-300 cursor-pointer w-[364px] m-auto hover:scale-105`}>
                    <Link href={btnLink}>
                        <a>{btnText}</a>
                    </Link>
                </div>
