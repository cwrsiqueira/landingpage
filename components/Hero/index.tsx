    ...
    return (
        <div className="flex bg-[#F7FAFC] justify-center mt-[140px] p-4 md:items-center md:h-[490px]">
            <div className="text-center">
                ...
                <div className={`font-bold text-xs text-white ${btnColor} px-[60px] py-[25px] rounded-md ease-in-out duration-300 cursor-pointer w-[278px] m-auto hover:scale-105 md:text-xl md:w-[400px]`}>
                    <Link href={btnLink}>
                        <a>{btnText}</a>
                    </Link>
                </div>
